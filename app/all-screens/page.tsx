...
const SCREENS = [
  ...
  { id: 9,  label: "Empty · Notifications" },
  { id: 10, label: "Empty · Withdrawals" },
  { id: 11, label: "Empty · Offers" },
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: 48, textAlign: "center" }}>
        ...
        >
          {SCREENS.length} screens — right-click any phone to inspect or screenshot for Figma
        </p>
      </div>
